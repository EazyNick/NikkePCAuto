...
레포지토리 즐겨찾기(별표=관심등록) 30개 넘어가면 ocr 기능도 추가해서 완전하게 자동화 하겠습니다. <br>
레포지토리 즐겨찾기(별표=관심등록) 50개 넘어가면 로직 개선해서 모든 환경에서 구현 가능하게, 완전하게 자동화 하겠습니다. <br>
레포지토리 즐겨찾기(별표=관심등록) 100개 넘어가면 매일 이벤트 미션 수행 기능도 추가해서 완전하게 자동화 하겠습니다. <br>
